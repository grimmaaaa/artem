...
class RentPlace(models.Model):
    ...
    location = models.CharField('Локация', choices=LocationCountries.choices, max_length=20)
    inhabiants = models.CharField('Обитатели', max_length=511)
    price = models.PositiveIntegerField('Цена', default=0)
    image = models.ImageField('Картинка', upload_to='images/places')
    place_type = models.CharField('Для охоты или рыбалки', choices=PlaceChoices.choices, max_length=10)
